...
public class DeleteCallRecord extends UseCase<DeleteCallRecord.RequestValue, DeleteCallRecord.ResponseValue>{

    private final RecordRepository mRecordRepository;

    public DeleteCallRecord(@NonNull RecordRepository recordRepository) {
