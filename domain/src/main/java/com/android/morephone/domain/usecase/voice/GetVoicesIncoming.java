...
public class GetVoicesIncoming extends UseCase<GetVoicesIncoming.RequestValue, GetVoicesIncoming.ResponseValue> {

    private final VoiceRepository mVoiceRepository;

    public GetVoicesIncoming(@NonNull VoiceRepository messageRepository) {
