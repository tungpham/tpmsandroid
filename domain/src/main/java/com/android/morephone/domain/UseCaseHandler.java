...
public class UseCaseHandler {
    ...
    public <T extends UseCase.RequestValue, R extends UseCase.ResponseValue> void execute(final UseCase<T, R> useCase, T values, UseCase.UseCaseCallback<R> callback) {
...
//                }
    ...
    private static final class UiCallbackWrapper<V extends UseCase.ResponseValue> implements UseCase.UseCaseCallback<V> {
        ...
        public UiCallbackWrapper(UseCase.UseCaseCallback<V> callback,
                                 UseCaseHandler useDataHandler) {
            mCallback = callback;
            mUseCaseHandler = useDataHandler;
        }
