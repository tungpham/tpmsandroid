...
public class GetCallRecords extends UseCase<GetCallRecords.RequestValue, GetCallRecords.ResponseValue>{

    private final RecordRepository mRecordRepository;

    public GetCallRecords(@NonNull RecordRepository recordRepository) {
