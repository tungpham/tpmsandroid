...
import static com.ethan.morephone.presentation.buy.payment.card.CreditCardUtils.EXTRA_VALIDATE_EXPIRY_DATE;
...
public class CardExpiryFragment extends CreditCardFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle state) {
        ...
        View v = inflater.inflate(R.layout.fragment_card_expiry, group, false);
