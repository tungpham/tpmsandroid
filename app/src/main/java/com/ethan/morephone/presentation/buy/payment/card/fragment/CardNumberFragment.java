...
import static com.ethan.morephone.presentation.buy.payment.card.CreditCardUtils.MAX_LENGTH_CARD_NUMBER;
import static com.ethan.morephone.presentation.buy.payment.card.CreditCardUtils.MAX_LENGTH_CARD_NUMBER_WITH_SPACES;
...
public class CardNumberFragment extends CreditCardFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup group, Bundle state) {
        View v = inflater.inflate(R.layout.fragment_card_number, group, false);
