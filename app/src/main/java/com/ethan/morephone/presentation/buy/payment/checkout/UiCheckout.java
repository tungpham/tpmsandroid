 ...
 * context of some UI (for example, {@link Activity} or {@link Fragment}) as it is
...
public abstract class UiCheckout extends Checkout {
     ...
     * Activity#onCreate(android.os.Bundle)} (or {@link Fragment#onCreate(android.os.Bundle)})
     ...
     * {@link Fragment#onActivityResult(int, int, Intent)}) in order to finish a started
     * purchase flow.
     *
