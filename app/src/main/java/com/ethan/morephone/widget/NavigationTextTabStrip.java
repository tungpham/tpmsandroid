...
public class NavigationTextTabStrip  extends View implements ViewPager.OnPageChangeListener {
    ...
    public NavigationTextTabStrip(final Context context) {
        this(context, null);
    }

    public NavigationTextTabStrip(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NavigationTextTabStrip(final Context context, final AttributeSet attrs, final int defStyleAttr) {
