package com.ethan.morephone.widget.recyclerview;
...
public class WrappingLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    private void logMeasureWarning(int child) {
        DebugTool.logD("WrappingLinearLayoutManager" + "Can't measure child #" + child + ", previously used dimensions will be reused." +
