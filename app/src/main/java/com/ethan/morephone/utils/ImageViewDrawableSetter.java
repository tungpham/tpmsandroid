...
public class ImageViewDrawableSetter {
    ...
    public Bitmap setupContactPhoto(ImageView photoView) {
        Account account = new Account("com.google", "truongnguyenptit@gmail.com");
        setTarget(photoView);
        return setCompressedImage(new byte[10], photoView.getContext(), account);
    }
